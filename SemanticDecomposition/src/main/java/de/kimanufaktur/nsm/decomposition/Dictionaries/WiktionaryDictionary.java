 ...
 * of the @see de.kimanufaktur.nsm.decomposition.dictionaries.wiktionary.WiktionaryCrawler.
 * The initial call of this function will unpack a wikipedia dump and create a database in
 * the de.kimanufaktur.nsm.decomposition.dictionaries.wiktionary target folder. If this database should be reused, please do not
