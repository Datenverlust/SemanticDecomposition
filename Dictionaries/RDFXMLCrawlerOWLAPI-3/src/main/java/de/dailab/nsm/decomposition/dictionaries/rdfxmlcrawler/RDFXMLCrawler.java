...
package de.dailab.nsm.decomposition.dictionaries.rdfxmlcrawler;
...
public class RDFXMLCrawler {
    ...
    public void index(){
        if(_ontIndexer == null){
            ...
            //values currently taken from de.dailab.nsm.decomposition.settings.Config
    ...
    public Set<String> typeOf(String entityIRI){
        ...
        _ontology.getEntitiesInSignature(entIri, true).forEach(e -> {
            ...
            if(e instanceof OWLClass){
                ...
                result.add ( ((OWLClass)e).getIRI().toString() );
            }
        });
        return result;
    }
