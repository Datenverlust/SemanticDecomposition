...
package de.dailab.nsm.decomposition.dictionaries.wordnet;
...
//    String source = "http://127.0.0.1/wordnet/ger/";
    ...
    public void initWordNet() {
        ...
        path2DBLocation = System.getProperty("user.home").toString() + File.separator + ".decomposition" + File.separator + "WordNet" + File.separator + "DB";
        try {
            if (wn == null) {
    ...
    public Set<IWord> getHypernyms(String word, POS worttype, int numberfoHypernyms) {
        return getSynset(word.toString(), numberfoHypernyms, worttype, Pointer.HYPERNYM);
    }
    ...
    public Set<IWord> getHyponyms(String word, POS worttype, int numberfoHypernyms) {
        return getSynset(word.toString(), numberfoHypernyms, worttype, Pointer.HYPONYM);
    }
    ...
    public Set<IWord> getRecursiveHyponyms(String word, POS worttype, int numberfoHypernyms) {
        ...
        Set<IWord> hypernyms = getHyponyms(word.toString(), worttype, numberfoHypernyms);
