...
public class MarkerPassingSemanticDistanceMeasure implements SemanticDistanceMeasureInterface {
    ...
    static de.kimanufaktur.nsm.decomposition.graph.spreadingActivation.MarkerPassing.MarkerPassingConfig markerPassingConfig = new de.kimanufaktur.nsm.decomposition.graph.spreadingActivation.MarkerPassing.MarkerPassingConfig();
     ...
     */
    private static de.kimanufaktur.nsm.decomposition.graph.spreadingActivation.MarkerPassing.DoubleMarkerPassing getDoubleMarkerPassing(Graph resultGraph, List<Map<Concept, List<? extends Marker>>> startActivation, Map<Concept, Double> threshold) {
        DoubleMarkerPassing doubleMarkerPassingAlgo = new de.kimanufaktur.nsm.decomposition.graph.spreadingActivation.MarkerPassing.DoubleMarkerPassing(resultGraph, threshold, DoubleNodeWithMultipleThresholds.class);
